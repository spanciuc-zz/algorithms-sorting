...
class SortingTest {
  ...
  @Test
  void sortAscendingWithRepetitions_whenParamNotNullAndNotEmpty_shouldSortAscendingAndReturn() {
    var expected = new Integer[]{-1, 2, 3, -1, -1, 1, 2, 3, 9};
    var unordered = Arrays.copyOf(expected, expected.length);
